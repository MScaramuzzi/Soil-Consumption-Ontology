 ...
 * [Onedrive folder](https://liveunibo-my.sharepoint.com/personal/valentina_presutti_unibo_it/_layouts/15/onedrive.aspx?originalPath=aHR0cHM6Ly9saXZldW5pYm8tbXkuc2hhcmVwb2ludC5jb20vOmY6L2cvcGVyc29uYWwvdmFsZW50aW5hX3ByZXN1dHRpX3VuaWJvX2l0L0VrUk1zbkVoX3BGQ3RLMF9lOS12VEVnQktRNTFlX3FqejBoU0J6MXBUdEpZVlE%5FcnRpbWU9UTVOTFBXMTcyVWc&id=%2Fpersonal%2Fvalentina%5Fpresutti%5Funibo%5Fit%2FDocuments%2FTeaching%2FKnowledgeEngineering%2D20%2D21%2FProjects%2FProject4%2D%20SoilConsumption%2FCal%C3%B2%2DScaramuzzi)
...
In order to launch fuseki we have executed the following command:
...
```bash
java -jar  limes-core-1.7.6-SNAPSHOT.jar ../pom1.xml
...
Here we want to represent which metric does the indicator subtend by showing the label associated to it.

<img src="image/CQ1.png" alt="hi" class="inline"/>

*Figure 8.1.1* - **Output generated by executing of the SPARQL engine**
...
*Figure 8.1.2* - **Output generated by executing of SPARQL engine**
...
*Figure 8.1.3* - **Output generated by executing the SPARQL engine**
...
*Figure 8.1.4* - **Output generated by executing the SPARQL engine**
...
*Figure 8.1.5* - **Output generated by executing the SPARQL engine**
...
*Figure 8.1.6* - **Output generated by executing the reasoner**


<img src="image/CQ9.png" alt="hi" class="inline"/>

Here we can see what a specific metric is defined through its associated parameter which clarifies the label that charcterizes the metric.
...
*Figure 8.1.7* - **Output generated by executing the SPARQL engine**
...
*Figure 8.1.8* - **Output generated by executing the SPARQL engine**
...
*Figure 8.2.1* - **Output generated by executing the SPARQL engine**
...
*Figure 8.3.1* - **Error provocation test**
...
*Figure 8.3.2* - **Metrics calculated by OWL**

Here we can see some relevant metrics for the ontology.
